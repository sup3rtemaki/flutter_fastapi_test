...
class GroceryList extends StatefulWidget {
  ...
  const GroceryList({Key? key, required this.handleAddItem, this.hidePurchased = false}) : super(key: key);
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (ctx, index) {
            ...
            String? categoryName = key != null ? GroceryItem.stringFromCategory(key) : null;
